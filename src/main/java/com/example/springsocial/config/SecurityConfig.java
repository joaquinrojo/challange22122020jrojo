        ...
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers("/auth/**", "/oauth2/**")
                        .permitAll()
                .antMatchers( "/externos/**").permitAll()
                .antMatchers( "/storage/**").permitAll()
                .antMatchers("/admin/**").hasAnyRole("ADMIN")
                .antMatchers("/usuarios/**").hasAnyRole("USER","MANAGER","ADMIN")
                .antMatchers("/mascotas/**").hasAnyRole("USER","MANAGER","ADMIN")
                .antMatchers("/other/**").hasAnyRole("USER","MANAGER","ADMIN")
