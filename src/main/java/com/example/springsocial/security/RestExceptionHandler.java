...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handlePersistenceException(final Exception ex, final WebRequest request) {
        ...
        System.out.println("testeando"+cause.getClass().getName());
        ...
        for (final ConstraintViolation<?> violation : consEx.getConstraintViolations()) {
          ...
          // final ApiError apiErroINTERNAL_SERVER_ERRORr = new ApiError(HttpStatus.BAD_REQUEST);
            //return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
            return buildResponseEntity(new ApiError(HttpStatus.BAD_REQUEST, errors, ex));
        }
        //errors+="fuera de la wea";
        //final ApiError apiError = new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, ex.getLocalizedMessage(), "error occurred");
        return buildResponseEntity(new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, errors, ex));
